...
if(fileTitleInput) fileTitleInput.addEventListener('keydown',e=>{ if(e.key==='Enter'){ e.preventDefault(); renameCurrent(); }});
const titleSaveBtn=document.getElementById('titleSaveBtn');
if(titleSaveBtn) titleSaveBtn.addEventListener('click', saveTitle);
